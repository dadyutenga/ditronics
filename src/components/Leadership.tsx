        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          >
            <div className="relative w-48 h-48 mx-auto">
              <div className="absolute inset-0 rounded-full bg-gradient-to-r from-[#00FFFF] to-[#FFD700] animate-pulse" />
            ...
            <div>
              ...
              <p className="text-gray-300 mb-6 max-w-lg mx-auto">
                A visionary leader with over X years of experience in technology and innovation. Driving DITRONICS
                towards excellence in digital solutions and technological advancement.
              </p>
