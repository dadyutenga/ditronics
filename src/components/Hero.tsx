            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-4">
                <div className="rounded-2xl overflow-hidden border-2 border-[#00FFFF] transform -rotate-6">
                  <Image
                    src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-9qAgGKyRcN1oT8Av8GY6nde4Ip284R.png"
                ...
                <div className="rounded-2xl overflow-hidden border-2 border-[#FFD700] transform rotate-6">
                  <Image
                    src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/WhatsApp%20Image%202025-02-15%20at%2014.43.38_5edfb27a.jpg-R6gOES2IvHRxm08nJAfLpUMc7XYbZK.jpeg"
